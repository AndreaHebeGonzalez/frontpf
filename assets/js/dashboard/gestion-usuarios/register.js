...
/*
    Desglose de la expresión regular:
        ...
        [A-Za-z\d@$!%*?&]{8,} : Conjunto de caracteres permitidos y longitud mínima de 8.
        $ : Fin de la cadena.
    */
...
Pasos a seguir:
Agregar manejo de respuestas del servidor: Vamos a manejar la respuesta del servidor después de enviar el formulario de registro. Esto incluirá verificar si el registro fue exitoso y recibir el token.

Guardar el token: Al recibir el token del servidor, lo guardaremos localmente (por ejemplo, en el almacenamiento local del navegador) para usarlo en las solicitudes futuras, como las que se realizan al dashboard del refugio.

Redireccionar al dashboard: Después de un registro exitoso y recibir el token, redireccionaremos al usuario al dashboard del refugio.
